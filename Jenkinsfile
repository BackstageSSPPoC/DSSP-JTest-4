...
// Repo: multilang-java-maven | Env: dev
...
// ================= CI STAGES =================
        ...
        stage('Setup Environment') {
            steps {
                sh '''
                echo "Maven project — no extra setup needed"
                '''
            }
        }
                  ...
                  withSonarQubeEnv('SonarQube') {
                      sh '''
                          mvn sonar:sonar \
                              ...
                              -Dsonar.java.binaries=target/classes -Dsonar.sources=src/main \
